...
def _predict_proba(model: LGBMClassifier, X_any) -> np.ndarray:
...
def evaluate_model(model: LGBMClassifier, X_test: pd.DataFrame, y_test: np.ndarray) -> Dict[str, object]:
...
def main():
    ...
    if RUN_MULTI_PATIENT_EVAL:
        ...
        try:
            out_xlsx = "lightGBM_xai_multi_patient_eval_detail.xlsx"
            out_xlsx_mean = "Light_GBM_xai_multi_patient_eval_mean.xlsx"
            out_xlsx_median = "Light_GBM_xai_multi_patient_eval_median.xlsx"
            out_xlsx_std = "Light_GBM_xai_multi_patient_eval_std.xlsx"
            ...
            print("️ Export multi-patient tabuliek zlyhal:", repr(e))
